...
(function(mod) {
  ...
  var keyMap = CodeMirror.keyMap.emacs = CodeMirror.normalizeKeyMap({
    // kill-region
    //! "Ctrl-W": # Browser
    "Ctrl+J": function(cm) {kill(cm, cm.getCursor("start"), cm.getCursor("end"), true);},
    // kill-line
    ...
    }, // OK but validate with left key
    // yank-pop
    "Alt-Y": function(cm) {cm.replaceSelection(popFromRing(), "around", "paste");},

    // set-mark-command
    "Ctrl-Space": setMark, // OK
    ...
    //! "Ctrl-H": function(cm) { killTo(cm, byChar, -1, false); }, // Browser
    "Backspace": function(cm) { killRegion(cm, false) || killTo(cm, byChar, -1, false); },

    // forward-word
    //! "Alt-F": move(byWord, 1), // Browser
    "Alt-Right": move(byWord, 1), // OK
    // backward-word
    "Alt-B": move(byWord, -1), // OK
    "Alt-Left": move(byWord, -1), // OK

    // kill-word
    "Alt-D": function(cm) { killTo(cm, byWord, 1, "grow"); }, // OK
    // backward-kill-word
    "Alt-Backspace": function(cm) { killTo(cm, byWord, -1, "grow"); }, // OK
    ...
    // backward-paragraph
    "Ctrl-Up": move(byParagraph, -1), // OK
    // forward-paragraph
    "Ctrl-Down": move(byParagraph, 1), // OK

    // backward-sentence
    "Alt-A": move(bySentence, -1), // OK
    // forward-sentence
    "Alt-E": move(bySentence, 1), // OK
    ...
    // transpose-chars
    //! "Ctrl-T" // Browser
    // "": repeated(function(cm) { cm.execCommand("transposeChars"); }),
    // "": "transposeChars", // ???
    ...
    // "Cmd-Z": repeated("undo"),
    // "Shift-Ctrl-Z": "redo",
    "Shift-Alt-,": "goDocStart", // OK
    "Shift-Alt-.": "goDocEnd", // OK
    //! "Ctrl-S": "findPersistentNext", // Wikijs
    //! "Ctrl-R": "findPersistentPrev", // Browser
    "Ctrl-G": quit,
    // "Shift-Alt-5": "replace",
    // "Alt-/": "autocomplete",
