    ...
    patterns: {
        ...
        patterns: {
            ...
            formula$: function (input) {
                if (input.match(/^\([a-z]+\)$/))
                    return null // state of aggregation = no formula
    ...
    ce: { // main parser
        transitions: mhchemParser.createTransitions({
            ...
            '...': {
                ...
                '*': {
                    action_: [{ type_: 'output', option: 1 }, { type_: 'insert', option: 'ellipsis' }],
                    nextState: '1'
                }
            },
            '. |* ': {
